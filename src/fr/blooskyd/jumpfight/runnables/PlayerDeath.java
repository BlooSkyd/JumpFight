...
public class PlayerDeath implements PlayerDeathRunnable {
    ...
    public void run(Player player, Player killer)
        ...
        if ( killer != null ) {
            ...
            if (!this.jumpFight.isCustom() && !this.jumpFight.isEvent()) fr.ziedelth.evolzapi.spigot.utils.PlayerUtils.getPlayer(killer).addEvoCoins(.5);
            ...
            if (!this.oneShot.isCustom() && !this.oneShot.isEvent()) fr.ziedelth.evolzapi.spigot.utils.PlayerUtils.getPlayer(killer).addEvoCoins(10);
